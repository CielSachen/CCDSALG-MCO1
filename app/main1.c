...
/**
 * @file main1.c
 * @brief The source code containing the implementation of the convex hull program using a slower sorting algorithm.
...
/** @brief The entry point of the convex hull program using a slower sorting algorithm. */
int main(void) {
